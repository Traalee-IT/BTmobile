    ...
    <View style={styles.container}>
      <View style={styles.head}>
        <View style={styles.backshare}>
          <Image source={require("../assets/imgFlowers1.png")}></Image>
          <Image source={require("../assets/Icon_Like.png")}></Image>
        </View>
        <Image source={require("../assets/iconWallet.png")} style={[styles.img, { width: '100%', height: 420 }]} ></Image>
      ...
      <View style={styles.foot}>
        <View style={styles.title}>
          ...
          <Image style={styles.heart} source={require("../assets/Icon_Like.png")}></Image>
        </View>
        <View>
